...
# Sample the CCN network and calculate the clustering coefficient
...
print(f"Average clustering coefficient of CCN network: {avg_clustering_coef_ccn}")

# Sample the CSN network and calculate the clustering coefficient
...
print(f"Average clustering coefficient of CSN network: {avg_clustering_coef_csn}")
